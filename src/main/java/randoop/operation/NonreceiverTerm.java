...
public final class NonreceiverTerm extends CallableOperation {
  ...
  public String toString() {
    ...
    @SuppressWarnings("determinism") // all implementation toString methods deterministic: value is a String, primitive, or class (see comment on field)
  ...
  public String toParsableString(
    ...
    if (value == null) {
      ...
      @SuppressWarnings("determinism") // all implementation toString methods deterministic: value is a primitive or String (see comment on field)
