...
public class ExpectedOutcomeTable {
  ...
  private final List<@PolyDet ExecutableBooleanExpression> postConditions =
   ...
   */
  private final List<@PolyDet List<@PolyDet ThrowsClause>> exceptionSets =
      new @PolyDet ArrayList<>();
  ...
  public TestCheckGenerator addPostCheckGenerator(TestCheckGenerator gen) {
    ...
    if (!hasSatisfiedPrecondition) {
      gen = new @PolyDet InvalidCheckGenerator();
    }
