...
public interface ClassVisitor {
   ...
   */
  void visit(@Det ClassVisitor this, @Det Class<?> c, @Det ReflectionManager reflectionManager);
   ...
   */
  void visit(@Det ClassVisitor this, @Det Enum<?> e);
   ...
   */
  void visitBefore(@Det ClassVisitor this, @Det Class<?> c);
